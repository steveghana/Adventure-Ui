    ...
    <>
      <ol class="nav_content">
        <li class="nav_content__item">
          <button onClick={closeNav} class="nav_button button--rhea"><span>Close</span></button>
        </li>
      </ol>
        ...
        <div class="list">
          <div class="indicator">
            <div class="id-selector">
              ...
              <div class="id-list-item hide_cursor" onClick={navigation}>Categories</div><br />
              <div class="id-list-item hide_cursor" onClick={navigation}>Projects</div><br />
              <div class="id-list-item hide_cursor" onClick={navigation}>Contact</div><br />
              <div class="id-list-item hide_cursor">Home</div><br />
              <div class="id-list-item hide_cursor">Categories</div><br />
              <div class="id-list-item hide_cursor">Projects</div><br />
              <div class="id-list-item hide_cursor">Contact</div><br />
            </div>
          </div>
          <div class="list-item hide_cursor">
            Home
          </div><br />
          <div class="list-item hide_cursor">Categories</div><br />
          <div class="list-item hide_cursor">Projects</div><br />
          <div class="list-item hide_cursor">Contact</div><br />
        </div>
      </div>
    </>
