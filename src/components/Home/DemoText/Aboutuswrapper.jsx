    ...
    return (
        <section data-scroll-section="" className="home_about_us_wrapper">
            <div className="about_content_wrapper">
                <div className="aboutus_text">You got a cool project in mind? Let's collaborate and create a <span> powerful </span> app or website for you.</div>
                <div className="sub_text">
                    ...
                    <div className="getintouch">
                        <span>Get in touch!</span>  <span className="getintouch_content__item">
                            <Link style={{ textDecor: 'none' }} to='/contactInfo'>

                                <div className="getintouch_link getintouch_link--iocaste">
                                    <span>Drop me an E-mail</span>
                                    <svg className="getintouch_link__graphic getintouch_link__graphic--slide" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
                                        <path d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0"></path>
                                    </svg>
                                </div>
                            </Link>
                        </span> or<span className="getintouch_content__item">
                            <Link style={{ textDecor: 'none' }} to='/contactInfo'>
            ...
            <svg className="hidden">
                ...
                <symbol id="icon-callarrow" viewBox="0 0 408 408">
                    ...
                    <polygon fill="#000000" fillRule="nonzero" points="204 0 168.3 35.7 311.1 178.5 0 178.5 0 229.5 311.1 229.5 168.3 372.3 204 408 408 204"></polygon>
                </symbol>
            </svg>
                    ...
                    <button className="large_btn_skoll-button large_btn_button--skoll skoll2">
                        <Link style={{ color: 'black' }} to='/contactInfo'>
                            <div className='btn_wrapper'>
                                ...
                                <div className="btn_text">Contact <br /> me</div>
                            </div>
                        </Link>
                    </button>
                </div>
