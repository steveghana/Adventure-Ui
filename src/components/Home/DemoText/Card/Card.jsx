            ...
            <div className="questioncard_wrapper">
                <div className="card_content">
                    <div className="card_content_wrapper">
                        ...
                        <div className="card_img" style={{ backgroundImage: `url("${cardImg.img}")` }}>
                        </div>
                    ...
                    <div className="card_footer">
                        <div className="card_footer_description">{cardImg?.cardDescription?.submission}</div>
                        <div className="card_footer_head_link">
                            <ArrowRightAlt />
                            <ol className="card_footer_content">
                                <li className="card_footer_content__item">
                                    <a href="/contactInfo" className="card_footer_link link--helike hide_cursor"><span>Lets Do This</span></a>
                                </li>
                            </ol>
                        </div>
                    </div>
