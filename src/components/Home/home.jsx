...
function Home() {
  ...
  return (
    <div className="project_content content--intro">
      <div class=".btn__item hide_cursor">
        <button
          ref={littlebubble}
          onClick={openNav}
          class="skoll-button button--skoll"
        >
          <span>
            <span>
              <Menu />
      ...
      <div data-scroll-container class="projects_content__inner">
        ...
        >
                ...
                <button class="button button--calypso">
                  <span>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      href="https://drive.google.com/file/d/114arxIEN-bEdgN2IQKkG_bF9LD55cYF_/view?usp=sharing"
                    >
                      Get Resume
                    </a>
                  </span>
          ...
          <div className="enter_wrapper hide_cursor" ref={bubble}>
            {isTablet ? (
              <Link to="/categories">
                <div className="entermobile" ref={text}>
                  explore
                </div>
              </Link>
            ) : (
